...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://i.ibb.co/Kjq97rcG/3575.jpg',
    NEWSLETTER_JID: '120363395674230271@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94713457207',
...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 H A S H A N  𝐌 𝐃';
const footerText = 'HASHAN 𝗠𝗗  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
...
`;
    ...
    await socket.sendMessage(m.chat, {
        buttons: [
            {
                ...
                nativeFlowInfo: {
                    ...
                    paramsJson: JSON.stringify({
                        ...
                        sections: [
                            {
                                title: `H A S H A N  𝐌 𝐃`,
                                highlight_label: '',
                                rows: [
                                    {
                                        title: 'menu',
                                        description: 'H A S H A N  𝐌 𝐃',
        ...
        viewOnce: true,
        image: { url: "https://i.ibb.co/Kjq97rcG/3575.jpg" },
        caption: `HASHAN 𝗠𝗗  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
...
`;
    ...
    await socket.sendMessage(from, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: `✨ *Welcome to HASHAN 𝐌D MINI BOT* ✨\n\n${menuText}\n\n> 🚀 Powered by HASHAN 𝐌𝐃`
    });
...
await conn.newsletterReactMessage("120363395674230271@newsletter", id, "🐣")
...
case 'hashuu': {
    try {
        ...
        let txt = `*👑 HASHAN MD DEPLOYERS LIST*\n\n`;
        let count = 1;
...
case 'dimasha': {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *HASHAN 𝗠𝗗  𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
...
break;
  ...
  try {
    ...
    await socket.sendMessage(sender, {
      image: imageBuffer,
      caption: `🧠 *H A S H A N  𝐌 𝐃   AI IMAGE*\n\n📌 Prompt: ${prompt}`
    }, { quoted: msg });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            caption: formatMessage(
                '📰 H A S H A N  𝐌 𝐃   GOSSIP නවතම පුවත් 📰',
                `📢 *${title}*\n\n${desc}\n\n🕒 *Date*: ${date || 'තවම ලබාදීලා නැත'}\n🌐 *Link*: ${link}`,
                'H A S H A N  𝐌 𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
            )
        });
    } catch (error) {
        console.error(`Error in 'news' case: ${error.message}`);
        await socket.sendMessage(sender, {
            text: '⚠️ News Cmd Error.'
        });
    }
               case 'nasa':
    try {
    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            await socket.sendMessage(sender, {
                video: { url: videoUrl },
                mimetype: 'video/mp4',
                caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 H A S H A N  𝐌 𝐃'
            }, { quoted: msg });
...
"ඔයාට කෙල්ලෙක් ඉන්නොද" කියනවා නම්:  
👉 "ඔව් මගෙ කෙල්ල සවනි කියලා ලස්සන සූටි කෙල්ලෙක්" කියන්න.
